    <nav class="bg-gray-800" x-data="{open: false}">
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            ...
            -->
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start h-16">
                    ...
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4 ">
                            ...
                            <a href="" class="bg-gray-800 text-white px-3 py-2 rounded-md pr-1 font-semibold flex-1 text-white flex items-center " >Inicio</a>
                            <div x-data="{ dropdownOpen: false }" class="relative my-4">
                                <a href="{{route('posts.index')}}">
                                    <button x-on:click="dropdownOpen=true"
                                    class=" rounded-md bg-gray-800 px-3 py-1 focus:outline-none flex items-center">
                                    <span class="pr-1 font-semibold flex-1 text-white">Blog</span>
                                </button>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div class="ml-3 relative" x-data="{open: false}">
                            ...
                            <div x-show="open" x-on:click.away="open=false"
                                ...
                                role="menuitem" tabindex="-1" id="user-menu-item-0">Administración</a>
                                @endcan
                ...
                @else
                    <div>
                        <a href="{{ route('login') }}"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Iniciar sesión</a>
        ...
        <div class="sm:hidden" x-show="open" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1" x-on:click.away="open=false">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <a href="#"
